...
# Now beecause some peaks are really prevalent like the twin peaks at 29, it's important to note




((
  rep_nucleotides = ggarrange(plot_nonreproducible_spectra_heatmap, plot_reproducible_spectra_heatmap, hmap, ncol=3, common.legend = T)
))
