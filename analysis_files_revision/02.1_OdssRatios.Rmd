...
plot_hcw= patient_counts_30 %>% filter(admitted_hospital == 0) %>% 
  group_by(surveillance_sample) %>% 
  ggplot(aes(x = INSTRUMENT_RESULT, y = n_var, color = surveillance_sample)) + 
  geom_point(shape = "") +
        geom_density_2d(aes(color = surveillance_sample)) + 
