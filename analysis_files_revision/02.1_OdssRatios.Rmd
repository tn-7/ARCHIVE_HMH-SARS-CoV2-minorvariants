...
((plot_admitted = ggplot(patient_counts_30, aes(x = INSTRUMENT_RESULT, 
                                              y = n_var, color = admitted_hospital)) + 
        geom_density_2d(aes(color = admitted_hospital)) + stat_cor(method = "spearman") +
    geom_smooth(method = "lm", se=TRUE) + theme_pubr()))


plot_admitted = ggplot(patient_counts_30, aes(x = INSTRUMENT_RESULT, 
                                              y = n_var, color = vaccine_status)) + 
        geom_density_2d(aes(color = vaccine_status)) + stat_cor(method = "spearman") +
